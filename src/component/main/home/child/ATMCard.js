    ...
    render(){
        ...
        return(
            <TouchableNativeFeedback onPress={() => navigate("ATMCardDetail", 
                ...
                <View style={{width: '85%', height: '35%', marginBottom: '2%', flexDirection:'column',
    ...
    render(){
        ...
        return(
            <View style={{flex: 1, flexDirection:'column'}}>
                <View style={{flex:13, alignItems: 'center', marginTop:'4%'}}>
                        ...
                        <Record navigate={navigate} stk="**** **** **** 2019" name="NGUYEN VAN A" 
