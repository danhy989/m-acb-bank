        ...
        return (
            <View style={{ flex: 1, flexDirection: 'column' }}>
                ...
                <View style={{ flex: 6, paddingHorizontal: PADDING_HORIZONTAL, backgroundColor: '#F4F6F8', alignItems: 'center' }}>
                    ...
                    <View style={{ borderWidth: 0.05, marginVertical: 10, height: 70, width: Metrics.screenWidth - PADDING_HORIZONTAL * 2 + 3, backgroundColor: '#FFFFFF', borderRadius: 5 }}>
                        <View style={{ flex: 1, marginHorizontal: 10, marginTop: 10, flexDirection: 'row', justifyContent: 'space-between' }}>
                            <Text>
                                Thanh toán
                            </Text>
                            <Text style={{ color: '#0E6DC2' }}>
                                0
                            </Text>
                        </View>
                        <Text style={{ flex: 1, marginHorizontal: 10 }}>(VND)</Text>
                    </View>

                    {
                        this.state.showMenhGia && (
                            <View style={{ borderWidth: 0.05, marginVertical: 10, height: 130, width: Metrics.screenWidth - PADDING_HORIZONTAL * 2 + 3, backgroundColor: '#FFFFFF', borderRadius: 5 }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', padding: 5 }}>
                                    <TouchableNativeFeedback>
                                        <View style={{ width: 70, height: 40, justifyContent: 'center', alignItems: 'center', borderRadius: 10, borderWidth: 0.2 }}>
                                            <Text>10.000</Text>
                                        </View>
                                    </TouchableNativeFeedback>
